...
def ocr(img_path,xmin, ymin, xmax, ymax):
    ...
    recognition_folder = os.path.join(detection_results_folder,'Data')
...
#    cv2.imshow("Image", temp)
    ...
    cv2.imwrite("../../Predicted output.jpg", Cropped)
...
recognition_results_folder = os.path.join(image_folder,'Test_Image_Recognition_Results') 
...
#            print(image, xmin, ymin, xmax, ymax)
            ...
            for single_prediction in prediction:
                ...
                ocr(img_path,xmin, ymin, xmax, ymax)
